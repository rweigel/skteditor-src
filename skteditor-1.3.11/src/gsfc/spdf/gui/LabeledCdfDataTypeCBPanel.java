 ...
 * Rights Reserved.
 *
 * $Id: LabeledCdfDataTypeCBPanel.java,v 1.9 2022/03/24 10:38:36 btharris Exp $
 */
...
/**
 * One or more CdfDataTypeComboBoxes with a single JLabel on a JPanel.
 *
 * @author B. Harris
 * @version $Revision: 1.9 $
 */
public class LabeledCdfDataTypeCBPanel 
    ...
    /**
     * The CdfDataTypeComboBoxes on this component
     */
    private CdfDataTypeComboBox[] comboBoxes;
   
   
 
    /**
     * Construct a LabeledCdfDataTypeCBPanel with the given label and a single
     * combo box.  
     *
     ...
     */
    public LabeledCdfDataTypeCBPanel(String label) {
    ...
    /**
     * Construct a LabeledCdfDataTypeCBPanel with the given label and the
     ...
     */
    public LabeledCdfDataTypeCBPanel(String label, int numFields) {
    ...
    /**
     * Construct a LabeledCdfDataTypeCBPanel with the given label, border, and 
     * a single combo box.  
     *
     ...
     */
    public LabeledCdfDataTypeCBPanel(String label, Border border) {
    ...
    /**
     * Construct a LabeledCdfDataTypeCBPanel with the given label, border, 
    ...
    public LabeledCdfDataTypeCBPanel(String label,  Border border, 
        ...
        comboBoxes = new CdfDataTypeComboBox[numFields];

        for (int i = 0; i < numFields; i++) {

            comboBoxes[i] = new CdfDataTypeComboBox();
            add(comboBoxes[i]);
        };
    ...
    /**
     * Sets the comboboxes to only have non-CHAR data types.
     */
    public void setNoCharTypes() {

        for(int i = 0; i < numFields; i++) {
            
            comboBoxes[i].setNoCharTypes();
        }
    }


    /**
     * Sets the comboboxes to only have numeric data types (no char
    ...
    public void setNumericOnlyTypes() {
        ...
        for(int i = 0; i < numFields; i++) {
            ...
            comboBoxes[i].setNumericOnlyTypes();
        }
    }
    ...
    public void CdfVersionAdjust(String cdfVersion) {
        ...
        for(int i = 0; i < numFields; i++) {
            ...
            comboBoxes[i].CdfVersionAdjust(cdfVersion);
        }
    }
    ...
    public void createEpochVarAdjust(String cdfVersion) {
        ...
        for(int i = 0; i < numFields; i++) {
            ...
            comboBoxes[i].createEpochVarAdjust(cdfVersion);
        }
 ...
 //       else {
   ...
   //     };
    ...
    public long getDataType(int index) {

        return comboBoxes[index].getDataType();
    }


    public void setDataType(int index, long value) {

        comboBoxes[index].setDataType(value);
    }
