 ...
 * Rights Reserved.
 *
 * $Id: SaveAction.java,v 1.8 2022/03/24 10:38:28 btharris Exp $
 */
...
public class SaveAction extends AbstractFileAction {
    ...
    private static final String DEFAULT_ICON_NAME = "Save16.gif";

    private static Icon DEFAULT_ICON;

    public SaveAction(SKTEditor myEditor) {
	this(myEditor, DEFAULT_NAME, DEFAULT_ICON);
    }

    public SaveAction(SKTEditor myEditor, String name, Icon icon) {
	super(name, icon);
